...
st.markdown('<p style="font-family:larg-cursive;font-size:70px; color:RYB Green;">Codex Leicester</p>', unsafe_allow_html=True)
...
def main():
    ...
    def chain_setup():
        ...
        llm=HuggingFaceHub(repo_id="CodexLeicester/oasst-sft-4-pythia-12b-epoch-3.5", model_kwargs={"max_new_tokens":1200})
